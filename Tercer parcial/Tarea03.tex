...
\begin{document}
	...
	\textbf{FECHA:} 23 de julio de 2026 \vspace{0.5cm}
	
	\noindent \textbf{INSTRUCCIONES.-} Conteste de manera completa las siguientes preguntas.
	
	\vspace{0.8cm}
	% ---------------- PREGUNTA A ---------------- %
	\noindent \textbf{A.- Realice el análisis para obtener las ecuaciones para el desplazamiento en z (\textit{out-of-plane}), x y y (\textit{in-plane}) dirección.}
	...
	\vspace{0.8cm}
	% ---------------- PREGUNTA B ---------------- %
	\noindent \textbf{B.- Explique los siguientes términos: \textit{wrap phase}, \textit{unwrapped phase}, \textit{fringe patterns}, \textit{period of fringe pattern}.}
	...
	\vspace{0.8cm}
	% ---------------- PREGUNTA C ---------------- %
	\noindent \textbf{C.- Explique "\textit{Spatial Sampling with CCD arrays}", "\textit{Spatial Resolution}" y "\textit{Sampling Theorem}".}
	...
	\vspace{0.8cm}
	% ---------------- PREGUNTA D ---------------- %
	\noindent \textbf{D.- Explique vector de sensitividad? Calcule los componentes del vector de sensitividad $K_x$, $K_y$ y $K_z$.}
	...
	\vspace{0.8cm}
	% ---------------- PREGUNTA E ---------------- %
	\noindent \textbf{E.- Encuentre los vectores de iluminación, observación y el vector de sensitividad tomando en cuenta la siguiente información:\\
		$\lambda = 0.473~\mu m$\\
	...
	\vspace{0.8cm}
	% ---------------- PREGUNTA F ---------------- %
	\noindent \textbf{F.- Describe la teoría de \textit{phase shifting} y \textit{phase stepping} métodos para obtener la fase óptica.\\
	...
	\vspace{0.8cm}
	% ---------------- PREGUNTA G ---------------- %
	\noindent \textbf{G.- Realice lo mismo que para el inciso F solo que debe simular los patrones de intensidad necesarios y obtenga la fase envuelta y desenvuelta. Favor de entregar imágenes y programas.}
	
	\textbf{Respuesta:}
	A continuación se presenta el \textit{script} en Python para simular y calcular las fases directamente mediante su ejecución de manera procedural. Al ejecutar este código, se generarán y mostrarán las imágenes resultantes (patrón original, fase envuelta y fase desenvuelta).
	...
	\vspace{0.8cm}
	% ---------------- PREGUNTA H ---------------- %
	\noindent \textbf{H.- Explicar, inferir y describir la utilidad de los algoritmos de carré y Hariharan. De un ejemplo.}
	...
	\vspace{0.8cm}
	% ---------------- PREGUNTA I ---------------- %
	\noindent \textbf{I.- Describa el método de modulación especial para encontrar la fase óptica: \textit{Off-Axis Interferometry (Fourier method)}. Describa cada una de las ecuaciones y agregue las imágenes obtenidas en cada paso del método de Fourier.}
	...
	\vspace{0.8cm}
	% ---------------- PREGUNTA J ---------------- %
	\noindent \textbf{J.- Deduzca la siguiente ecuación:
		\[
